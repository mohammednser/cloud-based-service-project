...
const Sidebar: React.FC = () => {
  ...
  const navItems = [
    ...
    { to: '/files', label: 'الملفات', icon: (
      // أيقونة ملف عصرية
      <svg className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M4 4h16v16H4z"/><path d="M8 2v4M16 2v4"/></svg>
    ) },
    { to: '/categories', label: 'شجرة التصنيفات', icon: (
      // أيقونة شجرة التصنيفات
